 ...
 * on GitHub Pages - `/sync-hub-admin/`. Vite hands that down as
 ...
 *
 * Every path in the codebase is written root-relative - `/overview`, never
 * `overview` - and the base is applied at exactly two boundaries: on the way
